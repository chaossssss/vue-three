  ...
  methods: {
    ...
    initMap() {
      ...
      const projection = d3
        ...
        .scale(1000)
        .translate([0, 0]);
      let colors = ["#02A1E2","#ff6000","#de00ff","#00ffd2","#fff600","#18ff00","#ff0000","#1200ff","#5c5c5c","#7f5399","#989953","#115488","#881135"]
      let materialArr = colors.map(item=>{
        let material_t = new THREE.MeshBasicMaterial({
          color: item,
          transparent: true,
          opacity: 0.6,
        })
      ...
      JIAXING.features.forEach((elem,index) => {
        // 定一个省份3D对象
        ...
        coordinates.forEach((multiPolygon) => {
          multiPolygon.forEach((polygon) => {
            ...
            const mesh = new THREE.Mesh(geometry, [materialArr[index].material_t, materialArr[index].material_s]);
