...
export default {
  ...
  methods: {
    ...
    addCube() {
      ...
      const cube = new THREE.Mesh(geometry, [arrowMaterial,arrowMaterial,arrowMaterial,arrowMaterial,,arrowMaterial]);
